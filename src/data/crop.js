...
export const crop = ({
  ...
  freeze(/** @type {farmhand.item} */ ({
    cropTimeline,
    doesPriceFluctuate: true,
    tier,
    type: type || itemType.CROP,
    value: value || (10 + getCropLifecycleDuration({ cropTimeline }) * tier * (Boolean(growsInto) ? 1 : 3)),
    ...(Boolean(growsInto) && {
      isSeed: true,
...
export const cropVariety = ({
  ...
  return { imageId, cropFamily, variety, ...crop(/** @type {farmhand.item} */ ({ ...cropVarietyProperties })) }
}
