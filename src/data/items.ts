...
export const rainbowFertilizer = freeze({
  ...
  type: FERTILIZER as farmhand.itemType,
...
export const sprinkler = freeze({
  ...
  isReplantable: true,
  name: 'Sprinkler',
  type: SPRINKLER as farmhand.itemType,
  value: 120,
})
...
export const scarecrow = freeze({
  ...
  isReplantable: true,
  name: 'Scarecrow',
  type: SCARECROW as farmhand.itemType,
  value: 160,
})
...
export const cowFeed = freeze({
  ...
  name: 'Cow Feed',
  type: COW_FEED as farmhand.itemType,
  value: 5,
})
...
export const huggingMachine = freeze({
  ...
  type: HUGGING_MACHINE as farmhand.itemType,
  value: 500,
})
...
export const milk1 = freeze({
  id: 'milk-1',
  name: 'Grade C Milk',
  type: MILK as farmhand.itemType,
  value: 40,
})
