...
export const appleSapling: farmhand.item = tree({
  ...
  // apple-tree-grown. The last entry is how many days the tree stays at
  // apple-tree-grown before it dies (becomes apple-tree-dead) - fruit
  // stops growing at that point, but the tree can still be chopped down
  // for wood.
  treeTimeline: [5, 5, 5, 5, 5, 200],
